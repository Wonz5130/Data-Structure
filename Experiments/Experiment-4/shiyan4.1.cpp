...
void Menu(){
    //system("cls");  
    printf("The menu of sort algorithm is:\n\n");  
    printf("1. SelectSort\n");  
    printf("2. InsertSort\n");  
    printf("3. BubbleSort\n");  
    printf("4. QuickSort\n");  
...
int main()
{
    ...
    */
    ...
    scanf("%d",&choose); 
    switch(choose){
        case 1:SelectSort(a,NUM);Output(a,NUM);break;
        case 2:InsertSort(a,NUM);Output(a,NUM);break;
        case 3:BubbleSort(a,NUM);Output(a,NUM);break;
        case 4:QuickSort(a,NUM);Output(a,NUM);break;
        case 5:MergeSort(a,NUM);Output(a,NUM);break;
